...
train_data, info = tfds.load("fashion_mnist", data_dir="../data/tfds/fashion_mnists/", split="train", with_info=True)
test_data = tfds.load("fashion_mnist", data_dir="../data/tfds/fashion_mnists/", split="test")
...
#         logints, loss_value = apply_gradient(optimizer, model, x_batch_train, y_batch_train)
#         losses.append(loss_value)
#     return losses
