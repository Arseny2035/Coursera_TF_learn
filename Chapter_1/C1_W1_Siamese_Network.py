...
plot_model(base_network, show_shapes=True, show_layer_names=True, to_file='../models/base-model.png')
...
output = layers.Lambda(euclidian_distance, name='output_layer', output_shape=eucl_dist_output_shape)([vect_output_a, vect_output_b])

# Specify the inputs and output of the model
model = Model([input_a, input_b], output)

# Plot model graph
plot_model(model, show_shapes=True, show_layer_names=True, to_file='../models/outer-model.png')
